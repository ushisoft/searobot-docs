...
3. 点击首页位置初始化图标进入【位置初始化】主界面进行初始化操作
   ![位置初始化](../attachment/images/media/image25.png)
...
2. 在APP首页，点击左下角的点管理图标，选择【点管理】进入点管理主界面
3. 点击右上角【新建】弹出提示框，选择【录制点】，输入点名称后，并选择点类型
   ![录点](../attachment/images/media/image34.png)
...
5. 绘制完成后通过地图右下方的【保存】按键保存
   ![手绘路径](../attachment/images/media/image42.png)

## 创建任务

创建任务用于执行多个跑点连续运行或者多个路径连续运行，或者多次自动运行某些跑点或者路径任务。

1. 在APP首页，点击左下角的组合任务图标，进入到【组合任务】功能界面
2. 点击右上角【新建】，输入任务名称，进入到新建任务界面
3. 点击顶部下拉框，会在左侧列表显示出之前创建的所有点、路径、区域和停车位，勾选需要添加的项目
   ![创建任务](../attachment/images/media/image44.png)

4. 点击列表右侧添加按钮，会弹出弹窗，其中可以添加设置机器人执行任务时的动作
   ![添加动作](../attachment/images/media/image46.png)
...
2. 点击任务右上角【查看】，可查看该任务中选择的点和路径
   ![组合任务](../attachment/images/media/image47.png)

3. 在任务详情界面可以点击【删除】删除该任务
   ![任务详情](../attachment/images/media/image48.png)
...
6. 任务执行过程中，可通过【结束】【暂停】【继续】按钮进行控制
   ![任务控制](../attachment/images/media/image49.png)

### 跑临时任务

1. 在APP首页，点击【开始任务】，进入组合任务界面
2. 点击【临时任务】，在临时任务界面中，通过顶部下拉框选择不同类型的任务（点、路径、区域）
   ![临时任务](../attachment/images/media/image50.png)
...
1. 在APP首页，点击左下角的点管理图标，点击【定时任务】，进入【定时任务】功能界面
   ![定时任务](../attachment/images/media/image51.png)

2. 点击右上角【新建】，进入【新增定时任务】功能界面，根据需要填写表单
   ![新增定时任务](../attachment/images/media/image52.png)
...
1. 在APP首页，点击左下角的点管理图标，点击【任务报告】，进入【任务报告】功能界面
   ![任务报告](../attachment/images/media/image53.png)

2. 点击表格行，可查看任务报告详情
   ![任务报告详情](../attachment/images/media/image54.png) 